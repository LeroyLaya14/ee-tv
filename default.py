...
def showLiveTV():
	...
	if ipaddress == '':
		xbmc.executebuiltin('XBMC.Notification(Info:,"IP Address Has Not Been Set - Please Do This Within Configure",3000,'+addon.getAddonInfo('icon')+')')
	else:
...
def showMainMenu():
	...
	util.addMenuItem('EE - Live TV', link, 'LiveTV.png', None, True)

	params={'recordings':'no'}
	link = util.makeLink(params)
	util.addMenuItem('EE - Recordings', link, 'RecordedTV.png', None, True)
